/**
 * Geographic proximity linking engine for Bouches-du-Rhône (13).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (43.29°N for Marseille)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(43.29°) ≈ 81.0 km
